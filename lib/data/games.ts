...
export const games: Game[] = [
  {
    ...
    subtitle:
      "Investigate crimes set throughout history to clear the name of the wrongly accused.",
    description:
      'A full 3D version of our 2d game jam game, "Wrongly Accused". Investigate crimes set throughout history; in each case clear the name of the wrongly accused by finding clues, interviewing suspects, and deducing the truth.',
    thumbnail:
  ...
  },
  {
    ...
    description:
      "Experience authentic ghost stories from Bangladesh in this atmospheric horror adventure. Explore mysterious locations, uncover dark secrets, and confront supernatural forces in this culturally rich narrative experience.",
  ...
  },
  {
    ...
    description:
      "Join Dr Sarah as she investigates strange occurrences in a mysterious village. Solve puzzles, interview villagers, and uncover the truth behind the supernatural events plaguing the community.",
  ...
  },
  {
    ...
    description:
      "Something is wrong. The buzzing won't stop. Explore a disturbing environment and uncover what's causing the relentless noise in this short but intense horror experience.",
  ...
  },
  {
    ...
    description:
      "Step into the 1970s and investigate a case of murder, terrorism based on true events that took place during the Years of Lead in 1970s Italy.",
    thumbnail:
  ...
  },
  {
    ...
    description:
      "Test your Bengali vocabulary with this engaging word puzzle game. Perfect for language learners and native speakers alike.",
    ...
    links: [
      {
        platform: "Web",
        url: "https://caffebd.itch.io/bangla-catchphrase",
        label: "play at itch.io",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Who knew trick-or-treating could be so dangerous. make the right choices and you might just save the planet. A short, fun horror game.",
